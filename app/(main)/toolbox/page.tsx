    ...
    >
      <div className="p-4 text-white min-h-full bg-black/90">
        ...
        <div className="mt-8 mb-6">
          <h2 className="text-lg font-semibold mb-1">📊 工具历史表现参考</h2>
          <p className="text-xs text-white/50 mb-4">结构环境回测</p>
          <div className="p-3 rounded-lg bg-white/5 border border-white/10 mb-4">
            <div className="text-xs text-white/60 leading-relaxed">
              以下统计基于特定宏观与结构环境下的历史样本汇总，用于评估工具在"合适环境中"的风险—收益性价比，不代表未来收益，不构成交易指令。
            </div>
          </div>

          {/* ToolBox A 历史表现 */}
          <div className="mb-6">
            <div className="text-sm font-medium text-white/80 mb-3">ToolBox A｜结构对冲工具（Structure Hedge）</div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10 mb-3">
          ...
          {/* ToolBox B 历史表现 */}
          <div className="mb-6">
            <div className="text-sm font-medium text-white/80 mb-3">ToolBox B｜波动管理工具（Volatility Management）</div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10 mb-3">
          ...
          {/* ToolBox C 历史表现 */}
          <div className="mb-6">
            <div className="text-sm font-medium text-white/80 mb-3">ToolBox C｜尾部风险与插针工具（Tail Risk）</div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10 mb-3">
              <div className="text-xs text-white/50 mb-2">适用环境</div>
              <div className="text-xs text-white/70 space-y-1">
                <div>• 熊市震荡 / 恐慌前兆</div>
